...
if __name__ == "__main__":
    ...
    figures_embed = f"{figures}/initial_embedding_remove_doublets"
    ...
    sc.pl.dotplot(
        adata,
        ['Cdh5','Col1a1','Ptprc','Epcam','Muc1','Muc5b','Foxa2','Cdh1','Krt8','Sox9','Tbx2','Kit','Car4','Sftpc','Hopx','Zbtb16','Ccnd3','Fkbp5'],
        groupby="leiden",
        dendrogram=False,
        show=False,
